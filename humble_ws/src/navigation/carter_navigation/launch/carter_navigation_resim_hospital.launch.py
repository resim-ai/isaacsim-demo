...
def generate_launch_description():
    ...
    param_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("carter_navigation"),
            "params",
            "carter_navigation_hospital_params.yaml",
        ),
    )
    ...
    rviz_config_dir = os.path.join(get_package_share_directory("carter_navigation"), "rviz2", "carter_navigation_namespaced.rviz")
    ...
    nav2_stack = [
        IncludeLaunchDescription(
            ...
            launch_arguments={"namespace": "carter1", "use_namespace": "True", "rviz_config": rviz_config_dir}.items(),
        ...
        Node(
            ...
            remappings=[
                ("cloud_in", ["/carter1/front_3d_lidar/lidar_points"]),
                ("scan", ["/carter1/scan"]),
            ],
            namespace='carter1',
            parameters=[
